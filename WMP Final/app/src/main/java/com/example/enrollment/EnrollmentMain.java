...
public class EnrollmentMain extends AppCompatActivity {
    ...
    private static final int MAX_CREDITS = 21; // Maximum credits allowed
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_enrollment); // Set the content view
        ...
        signOutButton.setOnClickListener(view -> {
            ...
            Intent intent = new Intent(EnrollmentMain.this, MainActivity.class);
    ...
    private void submitSelectedSubjects() {
        ...
        enrollmentRef.set(new EnrollmentData(selectedSubjects, totalCredits))
                .addOnSuccessListener(aVoid -> {
                    ...
                    Intent intent = new Intent(EnrollmentMain.this, EnrollmentSummary.class);
                    // Pass the array of selected subjects directly
                    intent.putExtra("selectedSubjects", selectedSubjects.toArray(new Subject[0])); // No need to cast to Serializable
                ...
                .addOnFailureListener(e -> {
                    Toast.makeText(EnrollmentMain.this, "Error saving enrollment: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                });
    }
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    for (QueryDocumentSnapshot document : task.getResult()) {
                        ...
                        subjects.add(new Subject(name, credits)); // Create Subject object and add to the list
                    }
                    displaySubjects(); // Display the loaded subjects
                } else {
                    // Show error message if the task fails
                    Toast.makeText(EnrollmentMain.this, "Error getting subjects: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
            ...
            checkBox.setOnCheckedChangeListener((buttonView, isChecked) -> {
                if (isChecked) {
                    ...
                    if (totalCredits + subject.getCredits() > MAX_CREDITS) {
                        Toast.makeText(EnrollmentMain.this, "Cannot exceed " + MAX_CREDITS + " credits.", Toast.LENGTH_SHORT).show();
